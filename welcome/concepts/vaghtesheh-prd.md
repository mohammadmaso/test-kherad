---
type: Reference
title: وقتشه — Product Requirements Document (MVP)
description: PRD for وقتشه (Vaghtesheh), a web-based appointment scheduling and clinic management platform for Iranian medical clinics, covering MVP scope, user roles, features, tech stack, and pricing.
resource: /wiki/welcome/source/وقتشه-product-requirements-document-mvp
tags: [product, PRD, clinic-management, appointment-scheduling, MVP, Iranian-market, React, Django, FastAPI, PostgreSQL]
timestamp: 2025-04-16T00:00:00+00:00
---

# وقتشه (Vaghtesheh) — Product Requirements Document (MVP)
